  ...
  return (
    <div className='Welcome'>  
      <div className="formDiv">
        ...
        <p className='messageP'>An activation link has been sent to <span></span> Please click on the link to verify your email and activate your TradExpress account.</p>
